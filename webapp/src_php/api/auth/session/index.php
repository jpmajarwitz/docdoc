...
if (empty($_SESSION['auth_user_id'])) {
    php_backend_json_response(200, ['authenticated' => false, 'csrfToken' => $_SESSION['csrf_token']]);
}
...
if (!auth_user_trial_is_active($user)) {
    auth_revoke_session_record($pdo, session_id());
    auth_clear_session_state();
    php_backend_json_response(200, ['authenticated' => false, 'trialExpired' => true, 'message' => 'Trial period has ended.', 'csrfToken' => $_SESSION['csrf_token']]);
}
