...
$htmlBody = sprintf(
    '<p>A-Ideation access request submitted.</p><ul><li>First name: %s</li><li>Last name: %s</li><li>Phone: %s</li><li>Email: %s</li><li>Job title: %s</li></ul>',
...
$textBody = "A-Ideation access request submitted.\n"
