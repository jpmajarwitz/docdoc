...
async function buildPrimaryPromptPreviewText() {
  ...
  function buildResunatorCritiqueRequest() {
    const messages = [
      ...
      { type: 'input_text', text: 'Resume file:' },
      { type: 'input_file', source: RESUNATOR_FILE_SOURCES.RESUME },
      { type: 'input_text', text: 'Job Description file:' },
      { type: 'input_file', source: RESUNATOR_FILE_SOURCES.JOB_DESCRIPTION }
    ]
  ...
  function buildApplyChangeItemsRequest(changeItemsInput = changeItems) {
    ...
    const applyMessages = [
      ...
      ...(isResunatorWorkflow && jobReqFile
        ? [
            {
              type: 'input_text',
  ...
  async function invokeOperation(operation) {
    ...
    if (isResunatorWorkflow && operation === OPERATIONS.CRITIQUE_PRIMARY && !jobReqFile) {
      setError('Upload the job description before critiquing the resume.')
      setCurrentMode(MODES.DOC_DEFINE)
      return
    }
            ...
            <div className="primary-upload-left">
              {isResunatorWorkflow ? (
                <>
                  ...
                  <label className="panel-label">Submit Resume</label>
                  <div className="file-selector-row">
                    <input
