...
async function buildPrimaryPromptPreviewText() {
  ...
  function buildResunatorCritiqueRequest() {
    const messages = [
      ...
      { type: 'input_file', source: 'supporting_document' }
    ]
  ...
  function buildApplyChangeItemsRequest(changeItemsInput = changeItems) {
    ...
    const applyMessages = [
      ...
      ...(isResunatorWorkflow && supportingFile
        ? [
            {
              type: 'input_text',
  ...
  async function invokeOperation(operation) {
    ...
    if (isResunatorWorkflow && operation === OPERATIONS.CRITIQUE_PRIMARY && !supportingFile) {
